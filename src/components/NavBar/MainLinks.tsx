...
import { IconQuestionMark, IconStepInto, IconTools, IconSearch, IconTarget, IconNews } from "@tabler/icons";
...
const data = [aboutData, toolsData, attackVectorsData, walkthroughsData, referencesData, newsData];
