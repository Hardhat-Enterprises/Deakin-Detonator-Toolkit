...
import { IconHome, IconQuestionMark, IconStepInto, IconTools, IconSearch, IconTarget, IconReportAnalytics } from "@tabler/icons";
...
const data = [homeData, aboutData, toolsData, attackVectorsData, walkthroughsData, scenarioTrainingData, referencesData];
