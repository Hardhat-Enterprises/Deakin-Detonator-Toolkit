...
const Urlsnarf = () => {
    ...
    const tutorial = "https://docs.google.com/document/d/1fXIoSA0NjcL0Ai-zH-7hc1-K4uW5BcV84QjJ-GY8rHo/edit?usp=sharing"; // Link to the official documentation/tutorial.
