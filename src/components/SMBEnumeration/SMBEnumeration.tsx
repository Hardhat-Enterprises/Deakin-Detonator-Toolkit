...
import { RenderComponent } from "../UserGuide/UserGuide";  // Ensure this is correctly imported
...
const SMBEnumeration = () => {
    ...
    // Uses the onTermination callback function of runCommandGetPidAndOutput
    ...
    const onSubmit = async (values: FormValuesType) => {
        ...
        if (!values.speed) values.speed = "T3"; // Default value for scan speed
