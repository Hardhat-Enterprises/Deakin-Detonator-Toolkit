...
import { CVE202141773 } from "./AttackVectors/CVE-2021-41773/CVE-2021-41773";
import CVE202144228 from "./AttackVectors/CVE-2021-44228/CVE-2021-44228";
import CVE202236804 from "./AttackVectors/CVE-2022-36804/CVE-2022-36804";
import CVE20221388 from "./AttackVectors/CVE-2022-1388/CVE-2022-1388";
import CVE202227925 from "./AttackVectors/CVE-2022-27925/CVE-2022-27925";
import FindOffset from "./Tools/FindOffset/FindOffset";
import Hashcat from "./Tools/Hashcat/Hashcat";
import JohnTheRipper from "./Tools/JohnTheRipper/JohnTheRipper";
import NmapTool from "./Tools/NmapTool/NmapTool";
import { ShodanAPITool } from "./Tools/Shodan/Shodan-API-Tool";
import SMBEnumeration from "./Tools/SMBEnumeration/SMBEnumeration";
import SnmpCheck from "./Tools/SnmpCheck/SnmpCheck";
import Hydra from "./Tools/Hydra/Hydra";
import Urlsnarf from "./Tools/Urlsnarf/Urlsnarf";
import { ZeroLogon } from "./Tools/ZeroLogon/Zerologon";
import SearchSploit from "./Tools/SearchSploit/SearchSploit";
import { WalkthroughsPage } from "../pages/Walkthroughs";
import SMBGhostScanner from "./Tools/SMBGhostScanner/SMBGhostScanner";
import ARPSpoofing from "./Tools/ArpSpoof/ArpSpoof";
import { CVE202224112 } from "./AttackVectors/CVE-2022-24112/CVE-2022-24112";
import Enum4Linux from "./Tools/Enum4Linux/Enum4Linux";
import Exif from "./Tools/Exif/Exif";
import DnsenumTool from "./Tools/DNSenumTool/DNSenumTool";
import Metagoofil from "./Tools/metagoofil/metagoofil";
import Dmitry from "./Tools/Dmitry/Dmitry";
import DNSMap from "./Tools/DNSMap/DNSMap";
import Gyoithon from "./Tools/Gyoithon/Gyoithon";
import NbtscanTool from "./Tools/NbtscanTool/NbtscanTool";
import Cewl from "./Tools/Cewl/Cewl";
import CloudBrute from "./Tools/CloudBrute/CloudBrute";
import NetcatTool from "./Tools/Netcat/Netcat";
import Sherlock from "./Tools/Sherlock/Sherlock";
import BEDTool from "./Tools/BedTool/BEDTool";
import Dnsrecon from "./Tools/Dnsrecon/Dnsrecon";
import Crackmapexec from "./Tools/Crackmapexec/Crackmapexec";
import FfufTool from "./Tools/Ffuf/FfufTool";
...
import Traceroute from "./Tools/Traceroute/Traceroute";
import Crunch from "./Tools/Crunch/Crunch";
import Meow from "./WalkthroughPages/Meow";
import FTPconnect from "./Tools/FTP/FTPconnect";
import GoldenEye from "./Tools/Goldeneye/Goldeneye";
import WPScan from "./Tools/WPScan/WPScan";
import Eyewitness from "./Tools/eyewitness/eyewitness";
import MrRobot from "./WalkthroughPages/MrRobot";
import Parsero from "./Tools/parsero/parsero";
import Arjuntool from "./Tools/Arjuntool/Arjuntool";
import ARPFingerprint from "./Tools/arpfingerprint/arpfingerprint";
import ForemostTool from "./Tools/Foremost/Foremost";
import Busqueda from "./WalkthroughPages/Busqueda";
import TheHarvester from "./Tools/theharvester/theharvester";
import PayloadGenerator from "./Tools/msfvenom/msfvenom";
import AircrackNG from "./Tools/AircrackNG/AircrackNG";
import AirbaseNG from "./Tools/AirbaseNG/AirbaseNG";
import Amass from "./Tools/Amass/Amass";
import Fcrackzip from "./Tools/Fcrackzip/Fcrackzip";
...
import RTsort from "./Tools/RTsort/RTsort";
import Rainbowcrack from "./Tools/Rainbowcrack/Rainbowcrack";
import Rtgen from "./Tools/rtgen/rtgen";
import NSLookup from "./Tools/NSLookupTool/NSLookupTool";
import ArpanameTool from "./Tools/Arpaname/arpaname";
import Nikto from "./Tools/Nikto/Nikto";
import Bully from "./Tools/Bully/Bully";
import Gitleaks from "./Tools/Gitleaks/Gitleaks";
import WhatWeb from "./Tools/WhatWeb/WhatWeb";
import Sublist3r from "./Tools/Sublist3r/Sublist3r";
import Arpscan from "./Tools/ArpScan/ArpScan";
import Whois from "./Tools/Whois/Whois";
import Masscan from "./Tools/Masscan/Masscan";
import TestSSL from "./Tools/Testssl/Testssl";
import Hping3 from "./Tools/Hping3/Hping3";
import SQLmap from "./Tools/SQLmap/SQLmap";
import Wifite from "./Tools/Wifite2/wifite";
import SlowHttpTest from "./Tools/slowhttptest/slowhttptest";
import Tiger from "./Tools/tiger/tiger";
import Unicornscan from "./Tools/Unicornscan/Unicornscan";
import Photon from "./Tools/Photon/photon";
import Arping from "./Tools/Arping/Arping";
import Sqlninja from "./Tools/Sqlninja/sqlninja";
import CVE202226134 from "./AttackVectors/CVE-2022-26134/CVE-2022-26134";
import Wafw00f from "./Tools/wafw00f/wafw00f";
import Fping from "./Tools/Fping/Fping";
import Subjack from "./Tools/Subjack/Subjack";
import CVE202222963 from "./AttackVectors/CVE-2022-22963/CVE202222963";
import Tcpdump from "./Tools/Tcpdump/Tcpdump";
import CVE202322515 from "./AttackVectors/CVE-2023-22515/CVE-2023-22515";
import CVE202322527 from "./AttackVectors/CVE-2023-22527/CVE-2023-22527";
import Dig from "./Tools/Dig/Dig";
import NewsFeed from "../components/NewsFeed/NewsFeed";
import NetDiscover from "./Tools/NetDiscover/NetDiscover";
