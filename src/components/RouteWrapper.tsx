...
export const ROUTES: RouteProperties[] = [
  ...
  },
  {
    ...
    element: <Fawn />,
    description:
      "A walkthrough on the Fawn HackTheBox Challenge showcasing DDT nmap tool",
    category: "",
  },
  {
    name: "Keeper",
  ...
  },
  {
    ...
    element: <Rtgen />,
    description:
      "A tool for generating random network traffic to simulate various network conditions and loads.",
