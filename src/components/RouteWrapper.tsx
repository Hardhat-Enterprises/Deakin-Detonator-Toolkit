...
export const ROUTES: RouteProperties[] = [
    ...
    },
    {
        ...
        path: "/tools/Cewl",
        element: <Cewl />,
        description: "A tool that generates custom wordlists by crawling websites.",
        category: "Password Cracking and Authentication Testing",
    },
    {
        name: "Crackmapexec",
    ...
    },
    {
        ...
        path: "/tools/Dirb",
        element: <DirbTool />,
        description: "A web content scanner that finds hidden directories and files on a web server.",
        category: "Web Application Testing",
    },
    {
        name: "dmitry",
    ...
    },
    {
        ...
        path: "/tools/dnsenum",
        element: <DnsenumTool />,
        description: "A DNS enumeration tool that gathers DNS records and subdomains.",
        category: "Information Gathering and Analysis",
    },
    {
        name: "DNSMap",
        path: "/tools/dnsmap",
        element: <DNSMap />,
        description: "A tool for discovering subdomains of a domain via brute-force.",
        category: "Information Gathering and Analysis",
    },
    {
        name: "Dnsrecon",
    ...
    },
    {
        ...
        element: <FTPconnect />,
        description: "A tool for connecting and interacting with FTP servers.",
    ...
    },
    {
        ...
        path: "/tools/hashcat",
        element: <Hashcat />,
        description: "A powerful password recovery tool that uses brute-force or dictionary attacks.",
        category: "Password Cracking and Authentication Testing",
    },
    {
        name: "Hydra",
        path: "/tools/Hydra",
        element: <Hydra />,
        description: "A fast brute-force tool for attacking login services like FTP, SSH, and HTTP.",
        category: "Password Cracking and Authentication Testing",
    },
    {
        name: "JohnTheRipper",
        ...
        description: "A fast password-cracking tool focused on detecting weak passwords.",
        category: "Password Cracking and Authentication Testing",
    },
    {
        name: "Metagoofil",
    ...
    },
    {
        ...
        path: "/tools/Netcat",
        element: <NetcatTool />,
        description: "A versatile tool for reading from and writing to network connections.",
        category: "Network Scanning and Enumeration",
    },
    {
        name: "Nikto",
        path: "/tools/Nikto",
        element: <Nikto />,
        description: "A web vulnerability scanner for identifying security issues on web servers.",
        category: "Web Application Testing",
    },
    {
        name: "Nmap",
        path: "/tools/nmap",
        element: <NmapTool />,
        description: "A network scanning tool that discovers hosts and services on a network.",
        category: "Network Scanning and Enumeration",
    },
    {
        name: "NSLookup",
        ...
        element: <NSLookup />,
        description: "A tool for querying DNS records of a domain.",
        category: "Network Scanning and Enumeration",
    },
    {
        name: "Parsero",
    ...
    },
    {
        ...
        description: "A tool to gather information about SMB shares and users on a network.",
        category: "Network Scanning and Enumeration",
    },
    {
