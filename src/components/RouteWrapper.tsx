...
export const ROUTES: RouteProperties[] = [
  ...
  },
  {
    ...
    element: <ZeroLogon />,
    description:
      "Zero Logon will let the penetester to perform an authentication attempts on windows server",
    category: "",
  },
  {
    name: "CVE-2021-44228",
    ...
    description:
      "Vulnerability in the Apache Log4j 2 Java library allowing RCE",
    category: "",
  },
  {
    name: "CVE-2022-36804",
  ...
  },
  {
    ...
    element: <FindOffset />,
    description:
      "Find the offset to the instruction pointer in a buffer overflow vulnerable binary.",
    category: "",
  },
  {
    name: "CVE-2022-24112",
  ...
  },
  {
    ...
    element: <Fawn />,
    description:
      "A walkthrough on the Fawn Hack The Box Challenge showcasing DDT nmap tool",
    category: "Miscellaneous",
  },
  {
    name: "Keeper",
  ...
  },
  {
    ...
    element: <Pentesting />,
    description:
      "A walkthrough on a Pentesting room with focus on brute force attack and privilege escalation",
  ...
  },
  {
    ...
    element: <AMAP />,
    description:
      "A network scanning tool used to identify open ports and services on targeted hosts.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "Arjun",
  ...
  },
  {
    ...
    element: <Arpscan />,
    description:
      "A tool that uses ARP requests to discover devices on a local network.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "ARP Spoofing",
  ...
  },
  {
    ...
    element: <Bully />,
    description:
      " A tool used for brute-forcing WPS PINs to gain unauthorized access to wireless networks.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "Cewl",
    ...
    element: <Cewl />,
    description:
      "A tool that generates custom word lists by crawling and analyzing web pages for useful words.",
    category: "Password Cracking and Authentication Testing",
  },
  {
    name: "Crackmapexec",
  ...
  },
  {
    ...
    element: <DirbTool />,
    description:
      "A tool used for directory and file brute-forcing on web servers to discover hidden resources.",
    category: "Web Application Testing",
  },
  {
    name: "dmitry",
  ...
  },
  {
    ...
    element: <DNSMap />,
    description:
      "A tool that can visualize and analyze DNS records associated with a domain or IP address",
    category: "Information Gathering and Analysis",
  },
  {
    name: "DNSRecon",
  ...
  },
  {
    ...
    element: <Eyewitness />,
    description:
      "A tool used for capturing screenshots and gathering information from web servers",
    category: "Web Application Testing",
  },
  {
    name: "Fcrackzip",
  ...
  },
  {
    ...
    element: <FTPconnect />,
    description:
      "A tool used for connecting to and interacting with FTP servers",
    category: "Miscellaneous",
  },
  {
    name: "Gitleaks",
    ...
    element: <Gitleaks />,
    description:
      "A tool used to detect sensitive information and secrets that may be exposed in Git repositories.",
    category: "Information Gathering and Analysis",
  },
  {
    name: "GoBuster",
  ...
  },
  {
    ...
    description:
      "A password cracking tool that supports various algorithms and methods to crack hashed passwords.",
    category: "Password Cracking and Authentication Testing",
  },
  {
    name: "Masscan",
  ...
  },
  {
    ...
    element: <NbtscanTool />,
    description:
      "A tool used for scanning and identifying NetBIOS names and associated IP addresses on a network.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "Netcat",
    ...
    element: <NetcatTool />,
    description:
      "A that can create, read, and write network connections using TCP or UDP protocols.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "Nikto",
  ...
  },
  {
    ...
    element: <NSLookup />,
    description:
      "A command-line tool used for querying DNS to obtain domain name or IP address information.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "Parsero",
    ...
    element: <Parsero />,
    description:
      "A Python script that reads a web server's robots.txt file to view and analyze Disallow entries.",
    category: "Web Application Testing",
  },
  {
    name: "RDPassSpray",
    ...
    element: <RDPassSpray />,
    description:
      "A tool for brute-forcing RDP services using username and password lists which is employed for password spraying attacks against remote desktop or RD services.",
    category: "Password Cracking and Authentication Testing",
  },
  {
    name: "RTsort",
    ...
    element: <RTsort />,
    description:
      "A subfunction of the Rainbow Crack tool used for sorting and managing created rainbow tables.",
    category: "Password Cracking and Authentication Testing",
  },
  {
    name: "Rainbowcrack",
    ...
    description:
      "A computer program which generates rainbow tables to be used in password cracking.",
    category: "Password Cracking and Authentication Testing",
  },
  {
    name: "SearchSploit",
  ...
  },
  {
    ...
    element: <Sherlock />,
    description:
      "A tool used to find and enumerate user accounts across various social media platforms.",
    category: "Information Gathering and Analysis",
  },
  {
  ...
  },
  {
    ...
    description:
      "A tool for simulating slow HTTP attacks to test web server resilience.",
    category: "Web Application Testing",
  },
  {
  ...
  },
  {
    ...
    element: <TShark />,
    description:
      "A command-line network analyzer that can capture, analyze, and troubleshoot network traffic.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "Unicornscan",
  ...
  },
  {
    ...
    element: <Urlsnarf />,
    description:
      "A tool used for capturing and logging HTTP requests and URLs transmitted over a network.",
    category: "Network Scanning and Enumeration",
  },
  {
    name: "WhatWeb",
