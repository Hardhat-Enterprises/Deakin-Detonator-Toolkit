...
const AirbaseNG = () => {
  ...
  const form = useForm({
    ...
    validate: {
      ...
      replayInterface: (value) =>
        value ? null : "WLAN interface is required.",
    },
  });
    ...
    >
      ...
      <form onSubmit={form.onSubmit(onSubmit)}>
        <Stack>
          ...
          {/* Basic Mode Inputs */}
          <TextInput
            label="Name of your fake host"
            required
            {...form.getInputProps("fakeHost")}
          />
          <TextInput
            label="Channel of choice"
            required
            {...form.getInputProps("channel")}
          />
          <TextInput
            label="Your WLAN interface"
            required
            {...form.getInputProps("replayInterface")}
          />
            ...
            <>
              ...
              <Tooltip label="Disable sending beacons">
                <Switch
                  ...
                  {...form.getInputProps("disableBeacons", {
                    type: "checkbox",
                  })}
                />
              </Tooltip>
          ...
          {customMode && (
            <>
              <TextInput
                label="Custom Configuration"
                {...form.getInputProps("customConfig")}
              />
              <TextInput
              ...
              />
              <div>
                <strong>Command Preview:</strong> airbase-ng{" "}
                {form.values.fakeHost} {form.values.customConfig}
              </div>
            </>
          )}
