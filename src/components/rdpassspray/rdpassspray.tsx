...
const RDPassSpray = () => {
    ...
    const onSubmit = async (values: FormValuesType) => {
        ...
        let args = [values.targetIP, "-U", values.usernameFile, "-P", values.passwordFile];
        ...
        CommandHelper.runCommandWithPkexec("rdpspray", args, handleProcessData, handleProcessTermination)
            .then(() => {
                setLoading(false);
            })
            .catch((error) => {
        ...
        >
            ...
            <form onSubmit={form.onSubmit(onSubmit)}>
                <Stack>
                    ...
                    />
                    <TextInput label="Spray Rate (Optional)" {...form.getInputProps("rate")} placeholder="e.g. 10" />
                    <Checkbox
                        label="Verbose Mode"
                        checked={verboseMode}
