...
function SQLmap() {
    ...
    const tutorial =
        "https://docs.google.com/document/d/1CqxVDNGUw1LTVkB0dgsE9xiyzJksLZ3Jh1u_UGb0N0A/edit?pli=1&tab=t.0#heading=h.ytpj5ebu7b6l"; // Link to the official documentation/tutorial
