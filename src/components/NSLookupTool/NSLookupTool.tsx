    ...
    return (
        <>
            <RenderComponent
                ...
                steps={steps}
                tutorial={"https://docs.google.com/document/d/1Yuyo7KHj-iWTjRyzcQpw_e2yMHfDU8ND5Xg0_uCFUDI/edit?usp=sharing"} // Empty string since we don't need the tutorial section
