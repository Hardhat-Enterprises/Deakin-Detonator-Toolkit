...
const steps =
    ...
    "2. Advanced Mode (Optional): Toggle 'Advanced Mode' to enable additional configuration options (see below for more details).\n\n" +
    ...
    "6. Start Aircrack-ng: Once all fields are configured, click 'Start Aircrack-ng' to begin the key recovery process.\n\n" +
    "=== WPA/WPA2-PSK Mode ===\n" +
    "1. WEP or WPA-PSK: Select 'WPA' from the dropdown menu.\n\n" +
    "2. Advanced Mode (Optional): Toggle 'Advanced Mode' to enable additional configuration options (see below for more details).\n\n" +
    "3. Wordlist(s) Filename(s): Specify the file path(s) to the wordlist(s) that will be used for the dictionary attack (e.g., /path/to/wordlist.txt).\n\n" +
    "4. Set AP Identifier (Optional): Provide the identifier for the access point you are targeting.\n\n" +
    "5. Packet Capture File: Specify the path and filename of the packet capture file containing the WPA handshake (e.g., /path/to/file.cap).\n\n" +
    "6. Save Key to Output File (Optional): Provide a file path and name where the recovered key will be saved.\n\n" +
    "7. Start Aircrack-ng: Click 'Start Aircrack-ng' to initiate the dictionary attack.\n\n" +
