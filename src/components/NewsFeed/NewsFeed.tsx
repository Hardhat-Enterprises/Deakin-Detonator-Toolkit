    ...
    const fetchNews = async () => {
        ...
        try {
            ...
            try {
                ...
                console.error("Reading cached news failed:", cacheError);
        ...
        <div style={{ padding: "1rem" }}>
            ...
            <div style={{ marginTop: "1rem" }}>
                {filteredNews.slice(0, visibleCount).map((item, index) => {
                    ...
                    return (
                        <Transition key={index} mounted={true} transition="fade" duration={400} timingFunction="ease">
                            {(styles) => (
                                <Card
                                    shadow="xs"
                                    radius="md"
                                ...
                                >
                                    <Group position="apart" style={{ marginBottom: "0.5rem" }}>
                                        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                                            ...
                                            {detectedCategory && (
                                                <Badge
                                                    color={categoryColors[detectedCategory]}
                                                    size="sm"
                                                    variant="filled"
                                                >
                                                    {detectedCategory}
