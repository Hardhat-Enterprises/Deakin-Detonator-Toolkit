 ...
 */
const handleInstall = async (dependencies: string[], setOutput: React.Dispatch<React.SetStateAction<string>>, setLoading: React.Dispatch<React.SetStateAction<boolean>>) => {
 ...
 */
const InstallationModal: React.FC<InstallationModalProps> = ({ isOpen, setOpened, feature_description, dependencies }) => {
        ...
        >
            <div>
                {loading ? (
                    ...
                    <Stack>
                        <Text>
                            Not all features that the Deakin Detonator Toolkit has available to you
                            are immediately available on installation. Some features require additional
                            components to be installed on your system. Please read the below description
                            carefully to decide if you would like to install the component and its dependencies.
                        </Text>
                        <Text>
                            Feature Description:
                        </Text>
                        ...
                        <Button onClick={() => handleInstall(dependencies, setOutput, setLoading)}>Install Component</Button>
                    </Stack>
                )}
