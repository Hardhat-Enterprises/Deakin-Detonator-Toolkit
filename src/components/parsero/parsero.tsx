        ...
        >
            ...
            <form onSubmit={form.onSubmit(onSubmit)}>
                ...
                <Stack>
                    ...
                    {SaveOutputToTextFile_v2(output, allowSave, hasSaved, handleSaveComplete)} {/* Render the save output to file component */}
                    <ConsoleWrapper output={output} clearOutputCallback={clearOutput} /> {/* Render the console wrapper component */}
                </Stack>
            </form>
        </RenderComponent>
    );
