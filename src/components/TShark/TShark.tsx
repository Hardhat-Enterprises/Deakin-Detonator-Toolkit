...
const TShark = () => {
    ...
    const tutorial = "https://docs.google.com/document/d/1o-gmZEqlV49kM4n_bPBlQaxRkK1mLcO-OSElhx1P-6M/edit?usp=sharing"; // Link to the official documentation/tutorial.
